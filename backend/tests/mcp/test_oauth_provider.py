...
def provider(rsa_keys):
    ...
    with mock_aws():
        ...
        yield JanusOAuthProvider(
            ...
            issuer_url="https://mcp.test.advisory.sc0red.com",
            consent_base_url="https://test.advisory.sc0red.com",
        )
...
class TestAuthorize:
    ...
    async def test_returns_consent_url(self, provider):
        ...
        assert url.startswith("https://test.advisory.sc0red.com/oauth/authorize?")
...
class TestLoadAccessToken:
    ...
    async def test_valid_token(self, provider):
        ...
        access_token = create_signed_access_token(
            ...
            client_id="c1", scopes=["read"], issuer="https://mcp.test.advisory.sc0red.com",
        )
