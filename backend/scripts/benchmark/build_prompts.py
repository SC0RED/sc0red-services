#!/usr/bin/env python3
"""Build ``benchmark_prompts.json`` from Janus's actual prompt templates.
...
def main() -> None:
    """Build benchmark_prompts.json from the 10 canonical Janus prompts."""
    builders = [
        build_arrow_yesno,
    ...
    output = {
        "metadata": {
            ...
            "created": "2026-05-15",
            "description": (
                "Janus benchmark prompts — one per distinct AI call site. "
                "Generated by build_prompts.py from real Janus prompt templates "
