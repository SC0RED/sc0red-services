...
- [x] 3.4 Visual verification on testing env: scroll to EBITDA section. Confirm the new legend renders below the confidence legend, one line, three colored dots matching the chips below. Hover-test on a leaf's dot row — the colors should match the legend exactly.
