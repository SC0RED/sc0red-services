...
- [ ] 2. Confirm-screen affordance to trigger resolution + review/edit results
  before analysis.
- [ ] 3. Confidence handling: ALL resolved URLs enter needs-validation as
  reviewable candidates (never silently asserted, per the spec); low-confidence
  or ambiguous ones are flagged/emphasized for explicit customer choice.
