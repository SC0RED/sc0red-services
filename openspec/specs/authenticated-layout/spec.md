...
The `(authenticated)` route group SHALL NOT affect URL paths. All existing routes (`/dashboard`, `/analyses`, `/scan/new`, `/team`, `/analysis/[id]`, `/portfolio/[scanId]`) SHALL continue to work at the same URLs.
