...
Graphical 2D strategy-map canvas with four perspective bands, chip + arrow rendering via React Flow, hover/focus tooltip detail surfacing, deterministic theme-column layout, and accompanying header/gaps/CTA UX.
