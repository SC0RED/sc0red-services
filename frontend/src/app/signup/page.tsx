...
export default function SignupPage() {
    ...
    const [form, setForm] = useState({
        name: '', email: '', password: '', orgName: '', orgType: 'pe_firm'
    })
        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '1.5rem' }} className="grid-bg">
            <div style={{ width: '100%', maxWidth: '460px' }}>
                ...
                <div className="card" style={{ padding: '2rem' }}>
                    <h1 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.375rem' }}>Create your account</h1>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            border: form.orgType === opt.value
                                                ? '2px solid var(--accent-blue)'
                                                : '1px solid var(--border)',
                                            background: form.orgType === opt.value
                                                ? 'rgba(59,123,246,0.08)'
                                                : 'var(--bg-surface)',
                                            color: form.orgType === opt.value ? 'var(--accent-blue)' : 'var(--text-secondary)',
                                            textAlign: 'left',
                                            cursor: 'pointer',
                                    ...
                                    >
                                        ...
                                        <div style={{ fontSize: '0.75rem', opacity: 0.7, marginTop: '2px' }}>{opt.desc}</div>
                                    </button>
                                ))}
                            </div>
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
                            ...
                            <div className="input-group">
                                ...
                                <input id="orgName" type="text" className="input"
                        ...
                        <div className="input-group">
                            ...
                            <input id="signup-email" type="email" className="input" placeholder="you@firm.com"
                        ...
                        {error && (
                            <div style={{
                                padding: '0.75rem 1rem', background: 'var(--risk-critical-bg)',
                                border: '1px solid rgba(239,68,68,0.3)', borderRadius: 'var(--radius-md)',
                                color: 'var(--risk-critical)', fontSize: '0.875rem',
                            }}>{error}</div>
                        )}

                        <button type="submit" className="btn btn-primary w-full"
                            style={{ justifyContent: 'center', marginTop: '0.375rem' }} disabled={loading}>
                    ...
                    <p style={{ textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>
                        ...
                        <Link href="/login" style={{ color: 'var(--accent-blue)', fontWeight: 500 }}>Sign in</Link>
                    </p>
                </div>
            </div>
        </div>
